...
def get_last_page(page: requests.Response) -> int:
...
def parse_html(page: requests.Response) -> None:
    # gather all links
    ...
    parse_list_items(all_items)


def parse_list_items(all_items: object) -> None:
    i = 0
